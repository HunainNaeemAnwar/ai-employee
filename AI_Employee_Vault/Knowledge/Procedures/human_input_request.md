...
```
Pending_Approval/INPUT_<uuid>.md
```
...
### Input File Created:
```
Pending_Approval/INPUT_abc123.md
```
...
```
Pending_Approval/APPROVAL_xyz789.md
...
| File Type | Location |
|-----------|----------|
| Input Requests | `Pending_Approval/INPUT_*.md` |
| Approvals | `Pending_Approval/APPROVAL_*.md` |
| Completed | `Done/` |
| Audit Logs | `Logs/YYYY-MM-DD.jsonl` |
...
ls -la AI_Employee_Vault/Pending_Approval/INPUT_*.md

# View an input request
cat AI_Employee_Vault/Pending_Approval/INPUT_<uuid>.md
